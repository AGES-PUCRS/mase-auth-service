package br.pucrs.ages.mase.authservice.swagger;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
                ...
                .globalResponseMessage(RequestMethod.PUT, defaultResponses).select().paths(PathSelectors.any())
                .apis(RequestHandlerSelectors.basePackage("br.pucrs.ages.mase.authservice.api")).build();
    }
